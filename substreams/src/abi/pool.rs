...
pub mod functions {
    ...
    impl Collect {
        const METHOD_ID: [u8; 4] = [47u8, 127u8, 23u8, 108u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Bool(self.token0_223.clone()),
                    ethabi::Token::Bool(self.token1_223.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl CollectProtocol {
        const METHOD_ID: [u8; 4] = [196u8, 86u8, 55u8, 12u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl Converter {
        const METHOD_ID: [u8; 4] = [189u8, 56u8, 131u8, 123u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Converter {
        const NAME: &'static str = "converter";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Converter {
    ...
    pub struct PoolLib {}
    impl PoolLib {
        const METHOD_ID: [u8; 4] = [180u8, 58u8, 177u8, 90u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PoolLib {
        const NAME: &'static str = "pool_lib";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for PoolLib {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl Set {
        const METHOD_ID: [u8; 4] = [226u8, 56u8, 216u8, 194u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.t0erc223)),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.t1erc223)),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.library)),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.converter)),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::Function for Set {
    ...
    impl Swap {
        const METHOD_ID: [u8; 4] = [33u8, 167u8, 97u8, 24u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Bool(self.prefer223.clone()),
                    ethabi::Token::Bytes(self.data.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl SwapExactInput {
        const METHOD_ID: [u8; 4] = [69u8, 135u8, 106u8, 110u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Bool(self.unwrap_eth.clone()),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl SwapSender {
        const METHOD_ID: [u8; 4] = [228u8, 110u8, 212u8, 6u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for SwapSender {
        const NAME: &'static str = "swap_sender";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for SwapSender {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(Vec<u8>, Vec<u8>)> for Token0 {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(Vec<u8>, Vec<u8>)> for Token1 {
        fn output(data: &[u8]) -> Result<(Vec<u8>, Vec<u8>), String> {
            Self::output(data)
        }
    }
    ...
    impl TokenReceived {
        const METHOD_ID: [u8; 4] = [137u8, 67u8, 236u8, 2u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for TokenReceived {
        const NAME: &'static str = "tokenReceived";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 4usize]> for TokenReceived {
    ...
    impl UnwrapWeth9 {
        const METHOD_ID: [u8; 4] = [196u8, 217u8, 204u8, 112u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.recipient)),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.weth9)),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(

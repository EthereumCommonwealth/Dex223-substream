...
pub mod functions {
    ...
    pub struct CreatePool {
        pub token_a_erc20: Vec<u8>,
        pub token_b_erc20: Vec<u8>,
        pub token_a_erc223: Vec<u8>,
        pub token_b_erc223: Vec<u8>,
        pub fee: substreams::scalar::BigInt,
    }
    impl CreatePool {
        const METHOD_ID: [u8; 4] = [226u8, 130u8, 180u8, 254u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            ...
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.token_a_erc20),
                    ),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.token_b_erc20),
                    ),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.token_a_erc223),
                    ),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.token_b_erc223),
                    ),
                    ethabi::Token::Uint(
    ...
    impl Set {
        const METHOD_ID: [u8; 4] = [137u8, 103u8, 92u8, 172u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.lib)),
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct StandardIntrospection {}
    impl StandardIntrospection {
        const METHOD_ID: [u8; 4] = [110u8, 173u8, 236u8, 210u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for StandardIntrospection {
        const NAME: &'static str = "standardIntrospection";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for StandardIntrospection {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TokenReceivedCaller {}
    impl TokenReceivedCaller {
        const METHOD_ID: [u8; 4] = [168u8, 233u8, 139u8, 181u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for TokenReceivedCaller {
        const NAME: &'static str = "tokenReceivedCaller";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for TokenReceivedCaller {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    pub struct PoolCreated {
        pub token0_erc20: Vec<u8>,
        pub token1_erc20: Vec<u8>,
        pub token0_erc223: Vec<u8>,
        pub token1_erc223: Vec<u8>,
        pub fee: substreams::scalar::BigInt,
        pub tick_spacing: substreams::scalar::BigInt,
        pub pool: Vec<u8>,
    }
    impl PoolCreated {
        ...
        pub fn decode(
            ...
            values.reverse();
            Ok(Self {
                token0_erc20: ethabi::decode(
                        &[ethabi::ParamType::Address],
                        log.topics[1usize].as_ref(),
                    )
                    .map_err(|e| {
                        format!(
                            "unable to decode param 'token0_erc20' from topic of type 'address': {:?}",
                            e
                        )
                    })?
                    .pop()
                    ...
                    .as_bytes()
                    .to_vec(),
                token1_erc20: ethabi::decode(
                        &[ethabi::ParamType::Address],
                        log.topics[2usize].as_ref(),
                    )
                    .map_err(|e| {
                        format!(
                            "unable to decode param 'token1_erc20' from topic of type 'address': {:?}",
                            e
                        )
                    })?
                    .pop()
